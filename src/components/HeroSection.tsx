      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center animate-fade-in">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto font-poppins leading-relaxed">
            Sistem absensi modern dan terpercaya untuk pegawai internal dan eksternal. 
            Catat kehadiran Anda dengan mudah, cepat, dan dapat diakses dari mana saja.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto animate-slide-up">
            <div className="flex items-center justify-center space-x-3 bg-white p-4 rounded-lg shadow-sm">
              ...
              <span className="text-gray-700 font-poppins">Mudah Digunakan</span>
            </div>
            <div className="flex items-center justify-center space-x-3 bg-white p-4 rounded-lg shadow-sm">
              <CheckCircle className="h-5 w-5 text-green-500" />
              <span className="text-gray-700 font-poppins">Akses dari Mana Saja</span>
            </div>
            <div className="flex items-center justify-center space-x-3 bg-white p-4 rounded-lg shadow-sm">
              <CheckCircle className="h-5 w-5 text-green-500" />
              <span className="text-gray-700 font-poppins">Data Aman & Terpercaya</span>
            </div>
          </div>
        </div>
      </div>
